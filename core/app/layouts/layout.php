...
<html>
  <head>
    <meta charset="UTF-8">
    <title>INVENSOFT | Panel de Administracion</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>INVEN</b>SOFT</span>
        </a>
   ...
   <?php endif; ?>
    ...
    <?php endif;?>
      ...
      <div class="content-wrapper">
        ...
        <strong>Copyright &copy; 2016 <a href="https://spokelopez.github.io/" target="_blank">COMSOFT</a></strong>
      </footer>
      <?php else:?>
        <?php if(isset($_GET["view"]) && $_GET["view"]=="clientaccess"):?>
<div class="login-box">
      <div class="login-logo">
        <a href="./"><b>INVEN</b>SOFT</a>
      </div><!-- /.login-logo -->
...
<div class="login-box">
      <div class="login-logo">
        <a href="./"><b>INVEN</b>SOFT <sup>v 6.1</sup></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
